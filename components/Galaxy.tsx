...
export default function Galaxy({
  ...
  const smoothMouseActive = useRef(1.0);
  ...
  return <div ref={ctnDom} className="galaxy-container" style={{ width: "100%", height: "100%", position: "absolute", inset: 0 }} {...rest} />;
}
