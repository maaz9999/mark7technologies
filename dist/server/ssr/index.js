...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-A1xjsTn4.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"33e2cbbebff1": async () => {
		const m = await import("./assets/GlobalBackground-C67A-3AT.js");
		return { get "GlobalBackground"() {
			return m["GlobalBackground"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DzQL5wMa.js");
		return {
			get "ErrorBoundary"() {
	...
	"9e6e9ac3847c": async () => {
		const m = await import("./assets/SystemArchitectureDiagram-C3EksAno.js");
		return { get "SystemArchitectureDiagram"() {
			return m["SystemArchitectureDiagram"];
		} };
	},
	"ab1697caf909": async () => {
		const m = await import("./assets/SiteChrome-BbagL4rv.js");
		return {
			get "SiteFooter"() {
				return m["SiteFooter"];
			},
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-DU5Ivp9W.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ddfa8ffaf81e": async () => {
		const m = await import("./assets/MotionPrimitives-CE72cthP.js");
		return {
			get "Hero3D"() {
				return m["Hero3D"];
			},
...
//#endregion
export { stripBasePath as C, __toESM as D, __toCommonJS as E, hasBasePath as S, __exportAll as T, withBasePath as _, getPrefetchedUrls as a, require_react as b, usePathname as c, createRscRequestHeaders as d, app_ssr_entry_default as default, createRscRequestUrl as f, toSameOriginAppPath as g, toBrowserNavigationHref as h, handleSsr, getMountedSlotsHeader as i, useRouter as l, resolveRelativeHref as m, getCurrentInterceptionContext as n, navigateClientSide as o, isHashOnlyBrowserUrlChange as p, getLayoutSegmentContext as r, prefetchRscResponse as s, require_jsx_runtime as t, ReadonlyURLSearchParams as u, isDangerousScheme as v, __esmMin as w, VINEXT_MOUNTED_SLOTS_HEADER as x, AppElementsWire as y };
